        ...
        <div class="flex flex-col gap-10 justify-start p-28">
            ...
            <div class="flex flex-col grid grid-cols-3 gap-10">
                <div class="gap-2 flex flex-col">
                    <img src="../assets/images/services_gravestone-repair.png" alt="service_1" class="h-2/5 rounded-xl">   
                    <div class="flex flex-col gap-3 p-10 shadow-2xl ">
                        <h1 class="text-xl font-bold">Gravestone Repair</h1>
                        <p class="text-sm text-gray-400">Pricing: </p>
                        <p class="text-sm text-gray-400">Time of Completion: </p>
                ...
                <div class="gap-2 flex flex-col ">
                    <img src="../assets/images/services-clean-up-drive.png" alt="service_1" class="h-2/5 rounded-xl">   
                    <div class="flex flex-col justify-start gap-3 p-10 shadow-2xl">
                        <h1 class="text-xl font-bold">Clean up Gravesite</h1>
                        <p class="text-sm text-gray-400">Pricing: </p>
                        <p class="text-sm text-gray-400">Time of Completion: </p>
                        <div class="flex items-center">
                            <svg aria-hidden="true" class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>First star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                ...
                <div class="gap-2 flex flex-col">
                    <img src="../assets/images/services_floral-decorations.png" alt="service_1" class="h-2/5 rounded-xl">   
                    <div class="flex flex-col justify-start gap-3 p-10 shadow-2xl ">
                        <h1 class="text-xl font-bold">Floral Decorations</h1>
                        <p class="text-sm text-gray-400">Pricing: </p>
                        <p class="text-sm text-gray-400">Time of Completion: </p>
                        <div class="flex items-center">
                            <svg aria-hidden="true" class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>First star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
